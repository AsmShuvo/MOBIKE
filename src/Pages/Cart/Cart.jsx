                    ...
                    <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
                        ...
                        <div class="mx-auto border-e mt-6 flex-1 space-y-6 lg:mt-0 w-2/3">
                            <div class="space-y-4 w-2/3 rounded-lg p-4 shadow-sm dark:border-gray-700 dark:bg-yellow-200 sm:p-6">
                                ...
                                <Link to="/dashboard/payment" class="flex w-full items-center justify-center rounded-lg bg-primary px-5 py-2.5  font-medium text-sm btn btn-primary text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Proceed to Checkout</Link>
