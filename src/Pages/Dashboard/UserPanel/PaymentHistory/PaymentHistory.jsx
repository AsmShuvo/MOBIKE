                    ...
                    <div className="p-1.5 min-w-full inline-block align-middle">
                        <div className="overflow-hidden">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                <thead>
                                    <tr>
                                        <th scope="col" className="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-500">Bike Model</th>
                                        <th scope="col" className="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-500">Total Price</th>
                                ...
                                <tbody className="divide-y divide-gray-200 dark:divide-neutral-700">
                                    {
                                        payments?.map(payment => (
                                            <tr key={payment.id}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{payment.status}</td>
